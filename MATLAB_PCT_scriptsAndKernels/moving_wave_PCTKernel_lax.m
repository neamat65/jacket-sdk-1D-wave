...
TPB=128;
wave1Dlax = parallel.gpu.CUDAKernel('wave1Dlax.ptx','wave1Dlax.cu');
wave1Dlax.ThreadBlockSize=[TPB 1 1];
wave1Dlax.GridSize=[ceil(N/TPB) 1];
...
for ts = 1:Num_ts
    ...
    f_tmp = feval(wave1Dlax,f_tmp,f,u,dt,dx,int32(N));
